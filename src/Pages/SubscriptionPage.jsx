       ...
       <>
          <div className=" bg-gradient-to-r from-[#89bcfe] to-[#0868E9] mt-8 p-10">
            ...
            <div className="text-center">
                <h1 className="text-4xl font-bold text-white">Become a subscriber <br />
                Cancel anytime. No hidden fees.</h1>
            </div>

            <section className="mt-10 flex gap-6 justify-center">
        ...
        <div className="text-center mt-10">
                <h1 className="text-4xl font-bold ">Subscribers get unlimited access to:</h1>
                <div className="flex gap-10 justify-center my-8">
                    <div className="text-start font-semibold text-xl space-y-3">
